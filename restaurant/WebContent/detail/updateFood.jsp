...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="<%=basePath%>/detail/style/images/title_arrow.gif"/> 更新新菜品
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="../Dishes/updateDishes.do" method="post" >
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
                        <tr>
							<td width="80px">菜系</td>
							<td><input type="text" name="theircuisine" disabled="true" class="InputStyle" value= ${Theircuisine } >*
						...
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="dishesname" class="InputStyle" value=${Dishesename }> *</td>
						</tr>
						<tr>
							<td>价格</td>
							<td><input type="text" name="price" class="InputStyle" value=${Price }> *</td>
						</tr>
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="vipprice" class="InputStyle" value=${Vipprice }> *</td>
						</tr>
