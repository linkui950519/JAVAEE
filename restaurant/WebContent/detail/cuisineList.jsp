...
<body>
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="../Cuisine/getCuisine.do" method=POST>
			<input type="hidden" name="method" value="search">
 			 <input	type="text" name="name" title="请输入菜系名称"> 
			 <input	type="submit" value="搜索"><h7>请输入菜系名称查询</h7>
		</form>
	</div>
	<!-- 主内容区域（数据列表或表单显示） -->
	<div id="MainArea">
		<table class="MainArea_Content" align="center" cellspacing="0"
			...
			<!--显示数据列表 -->
			<tbody id="TableData">
		  <c:forEach items="${page.datas }" var="Cuisine">
					<tr align="center" valign="middle" id="TableTitle">
						<td class="td07">${Cuisine.ID }</td>
						<td class="td07">${Cuisine.cuisinename }</td>
	      ...
	      <tr>
	        ...
	        <a href="../Cuisine/CuisineManage.do?pageno=${page.pageno + 1 }">下一页</a>　 
	        <img src="<%=basePath%>/detail/style/images//3.gif" width="4" height="5" align="absmiddle">
	         <a href="../Cuisine/CuisineManage.do?pageno=${page.totalPages }">末页</a>　
	      ...
	      <tr>
	        <td colspan="5" align="left" class="td07"><img src="<%=basePath%>/detail/style/images/1.gif" width="4" height="5" align="absmiddle">
	         <a href="../Cuisine/CuisineManage.do?pageno=1">首页</a>　
	          <img src="<%=basePath%>/detail/style/images/2.gif" width="3" height="5" align="absmiddle"> 
	          <a href="../Cuisine/CuisineManage.do?pageno=${page.pageno - 1 }">上一页</a>　
	           <img src="<%=basePath%>/detail/style/images/2-2.gif" width="3" height="5" align="absmiddle"> 下一页　
