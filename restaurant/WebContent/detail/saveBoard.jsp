...
<body>
<select name="aaa">
	<c:forEach var="aa" items="${zxczxcz}">
		<option value="${aa.name}">${aa.name}</option>
	</c:forEach>
</select>
...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="<%=basePath%>/detail/style/images/title_arrow.gif"/>  添加新桌
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="../CuisineTable/addCuisineTable.do" method="post">
		<!-- 本段标题（分段标题） -->
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="<%=basePath%>/detail/style/images/item_point.gif"> 新桌信息&nbsp;
        </div>
		<!-- 本段表单字段 -->
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td><input type="text" name="name" class="InputStyle"/>*</td>
							 <td> <h7>${saveCuisineTablefalg}</h7></td>
						</tr>
					</table>
				</div>
            </div>
