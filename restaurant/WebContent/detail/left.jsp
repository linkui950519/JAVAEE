	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="../CuisineTable/CuisineTableManage.do?pageno=1">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="../Cuisine/CuisineManage.do?pageno=1">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="../Dishes/DishesManage.do?pageno=1">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="../Preorder/PreorderManage.do?pageno=1">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
